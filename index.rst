.. Guía de Alumnado MITE 2025 documentation master file, created by
   sphinx-quickstart on Thu Jan  9 20:34:36 2025.
...
A lo largo de estas **próximas tres semanas**, te invitamos a embarcarte en un viaje de descubrimiento y experimentación en el planificación de tu propio :bdg-link-primary:`PROYECTO DE TRABAJO FIN DE MÁSTER` en :bdg-link-primary-line:`TÉCNOLOGÍA EDUCATIVA`.  
Te centrarás en desarrollar el :bdg-link-success:`MARCO CONCEPTUAL` de tu investigación, que es el núcleo fundamental de cualquier investigación rigurosa. Todo esto se reduce a la siguiente pregunta clave:  
...
Al finalizar, diseñarás un :bdg-link-primary:`PROYECTO DE TRABAJO FIN DE MÁSTER`, fundamentado en principios éticos, teóricos y metodológicos que garanticen el rigor y la relevancia de la investigación educativa. Todo esto lo lograrás a través del desarrollo de competencias clave que te permitirán estructurar, justificar y presentar un proyecto sólido, capaz de sentar las bases para investigaciones futuras en el ámbito educativo y para la elaboración de tu Trabajo Fin de Máster en Educación Digital.

¿Qué te llevarás de esta asignatura? 
-----------------------------

Las competencias investigadoras necesarias para planificar el :bdg-link-success:`MARCO CONCEPTUAL` con los elementos esenciales de un proyecto de investigación en Tecnología Educativa:
 
* Seleccionar la :bdg-link-success-line:`TEMÁTICA` de tu investigación realista, teniedo en cuenta tus intereses y necesidades.

* Reflexionar sobre tu :bdg-link-success-line:`POSICIONAMIENTO CIÉNTIFICO` como investigador. 

* Realizar una :bdg-link-success-line:`REVISIÓN DE LA LITERATURA` sistemática inicial y actualizada.

* Definir un :bdg-link-success-line:`PROBLEMA DE INVESTIGACIÓN` relevante y viable.

* Establecer las :bdg-link-success-line:`PREGUNTAS DE INVESTIGACOIÓN` pertinentes y claras.

* Formular los :bdg-link-success-line:`OBJETIVO GENERAL Y ESPECÍFICOS` de forma precisa y alcanzable.

* Diseñarás un :bdg-link-success-line:`DISEÑO DE INVESTIGACIÓN` adecuado al contexto y a los objetivos planteados, que cumpla con los estándares éticos más rigurosos.
